...
function update_buttons() {
  (0, _jquery2.default)('.add-time-block').each(function (_, bb) {
    var task_id = (0, _jquery2.default)(bb).data('task_id');
    var time_start = (0, _jquery2.default)(bb).data('time-start');
    if (time_start == "hello") {
...
function set_button(task_id, value) {
  (0, _jquery2.default)('.add-time-block').each(function (_, bb) {
    if (task_id == (0, _jquery2.default)(bb).data('task-id')) {
      (0, _jquery2.default)(bb).data('time-start', value);
    }
  });
  update_buttons();
}
...
function follow_click(ev) {
  ...
  var start_time = btn.data('time-start');
...
function init_follow() {
  if (!(0, _jquery2.default)('.add-time-block')) {
    return;
  }

  (0, _jquery2.default)(".add-time-block").click(follow_click);

  update_buttons();
}

(0, _jquery2.default)(init_follow);
